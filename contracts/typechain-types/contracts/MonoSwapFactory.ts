...
export interface MonoSwapFactoryInterface extends Interface {
  getFunction(
...
export interface MonoSwapFactory extends BaseContract {
  connect(runner?: ContractRunner | null): MonoSwapFactory;
  waitForDeployment(): Promise<this>;

  interface: MonoSwapFactoryInterface;
